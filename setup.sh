...
wget https://drive.google.com/uc?export=download&id=15L3ACPMs5kDEi2w6RGpfps3T8s1_rQKX -O bio/bioasq_train.jsonl.gz
wget https://drive.google.com/uc?export=download&id=1vTWXF-3PRKPYK4xU66odVG8O3tytDerE -O bio/bioasq_dev.jsonl.gz
